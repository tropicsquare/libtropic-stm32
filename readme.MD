...
> [!IMPORTANT]
> We strongly recommend reading the [Libtropic SDK documentation](https://tropicsquare.github.io/libtropic/latest/) to familiarize yourself with the basic concepts before proceeding.

Choose the instructions for the hardware you want to use:
* [Nucleo F439ZI](./NUCLEO_F439ZI/README.md)
* [Nucleo L432KC](./NUCLEO_L432KC/README.md) (currently not supported)
